# Criando uma tabuada. Crie um algoritmo que leia um numero
# e mostre o resultado um tabuada de multiplicação do numero lido

n = int(input('Digite um numero que você queira ver a tabuada: '))
